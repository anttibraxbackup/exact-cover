...
import fi.iki.asb.xcc.words.item.CellOccupation;
import fi.iki.asb.xcc.words.item.ColOccupation;
import fi.iki.asb.xcc.words.item.RowOccupation;
import fi.iki.asb.xcc.words.item.WordConsumption;
import fi.iki.asb.xcc.words.option.Direction;
